...
This is because the user has role: "customer" and not "admin". Only "admin" users can see the contents of the "Back Office" field. Now let's assume that he wants to make a reservation on the facility with name: "Basketball court" as it is shown below:
